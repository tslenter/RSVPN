...
By enrolling this unit, clients/core layer can connect with an encrypted connection. Make sure if you make this unit a central place to connect that the VPN network 192.168.30.0/24 is known within the infrastructure netwerk.
